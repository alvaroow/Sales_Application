...
class ModPegawai : AppCompatActivity() {
    ...
    private lateinit var spStatus: AutoCompleteTextView // ✅ Tambahan Dropdown Status
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spStatus = findViewById(R.id.spStatusPegawai) // ✅ Hubungkan ID
    ...
    private fun saveOrUpdate() {
        ...
        val pegawai = ModelPegawai(id, nama, telp, status) // ✅ Simpan status
